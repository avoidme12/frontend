...
import {albumsData, assets, relaxedSongsData, songsData} from "@/assets/assets.js";
                    ...
                    songsData.map((item, index) => (
                        ...
                        >
                            ...
                            <div className='flex ml-[115%]'>
                                <Button onClick={() => console.log(item.id)} className='bg-black text-white font-semibold duration-300 mr-6' variant="outline">Delete Song</Button>
